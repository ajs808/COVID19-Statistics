...
class DummyTab extends StatefulWidget {
  ...
  const DummyTab({Key key, this.androidDrawer}) : super(key: key);

  final Widget androidDrawer;

  @override
  _DummyTabState createState() => _DummyTabState();
}
...
class _DummyTabState extends State<DummyTab> {
  ...
  List<String> cardValues = List<String>(_itemsLength);
  ...
  void _setData () {
    getValues(_itemsLength).then((List<String> result){
      setState(() {
        cardValues = result;
      });
    });
