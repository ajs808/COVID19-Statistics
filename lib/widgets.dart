...
class HeroAnimatingSongCard extends StatelessWidget {
  HeroAnimatingSongCard(
      {this.song, this.color, this.heroAnimation, this.onPressed, this.value,});
  ...
  double get playButtonSize => 50 + 20* heroAnimation.value;
...
//                        size: playButtonSize, color: Colors.black38),
                    child: Text(
                      '$value',
                      style: TextStyle(
                          fontWeight: FontWeight.bold, fontSize: playButtonSize,
                      ),
                    ),
                  ),
                ),
